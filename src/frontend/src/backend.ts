...
export class Backend implements backendInterface {
    ...
    async getLatestAppIdea(): Promise<AppIdea> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestAppIdea();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitAppIdea(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAppIdea(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
